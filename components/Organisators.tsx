...
const Organisators = () => {
  ...
  const { organisators: t } = require(`@/assets/i18n/${router.locale}.json`)

  const organisators = require(`@/assets/collections/organisators/${router.locale}.json`)
